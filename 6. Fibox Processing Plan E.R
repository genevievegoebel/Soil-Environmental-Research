...
files <- list.files(path = "2019-10-18 SWaN", pattern = "*.csv", full.names = TRUE, recursive = FALSE)
...
begin <- as.POSIXct("2019-10-18 00:00:01")
...
write.csv(selected, "2019-10-18 Selected Segments.csv")
...
processeddata <- read_csv("2019-10-18 Processed Data.csv", col_types = "dccffcdddd")
...
write.csv(processeddata, "2019-10-18 Processed Standards Out.csv")
